...
- Menu settings close the journal after a paste or copy, take or leave the journal's keys (`Intercept Keys`, on by default), and switch theme and interface language (System, English, Русский).
